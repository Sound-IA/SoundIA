...
function Footer() {
  return (
    <div className="flex z-10 relative w-full font-semibold bg-footer-form-icon-bg text-white h-16 items-center md:w-full md:items-center lg:items-center lg:flex-row">
